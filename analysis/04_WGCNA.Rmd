...
WGCNA_matrix_sorted=WGCNA_matrix[SampleInfo$label_rep, order(colors_new)]

collabels = SampleInfo[,c("CellLine","gRNA","DIFF", "RAPA")] %>%  
  mutate_all(as.character) %>% as.data.frame()

rownames(collabels)=SampleInfo$label_rep
