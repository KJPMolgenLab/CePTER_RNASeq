...
getlinmodoutput_all = function(targetdiff, 
  ...
  restab=data.frame(
    ...
    D244_log2FC_2.1 = get(paste0("restab_", 
                                 ...
                                 targetdiff, "_" , 
                                 targetrapa))$log2FoldChange[idx], 
    D244_pval_2.1 = get(paste0("restab_", 
                               "D244_sgNTC_sg2.1_", 
                               targetdiff, "_" , 
                               targetrapa))$padj[idx], 
    D244_log2FC_2.2 = get(paste0("restab_", 
                                 ...
                                 targetdiff, "_" , 
                                 targetrapa))$log2FoldChange[idx], 
    D244_pval_2.2 = get(paste0("restab_", 
                               "D244_sgNTC_sg2.2_", 
                               targetdiff, "_" , 
                               targetrapa))$padj[idx], 
    D62_log2FC_2.1 = get(paste0("restab_", 
                                ...
                                targetdiff, "_" , 
                                targetrapa))$log2FoldChange[idx], 
    D62_pval_2.1 = get(paste0("restab_", 
                              "D62_sgNTC_sg2.1_", 
                              targetdiff, "_" , 
                              targetrapa))$padj[idx], 
    D62_log2FC_2.2 = get(paste0("restab_", 
                                ...
                                targetdiff, "_" , 
                                targetrapa))$log2FoldChange[idx], 
    D62_pval_2.2 = get(paste0("restab_", 
                              "D62_sgNTC_sg2.2_", 
                              targetdiff, "_" , 
                              targetrapa))$padj[idx], 
    ReN_log2FC_2.1 = get(paste0("restab_", 
                                ...
                                targetdiff, "_" , 
                                targetrapa))$log2FoldChange[idx], 
    ReN_pval_2.1 = get(paste0("restab_", 
                              "ReN_sgNTC_sg2.1_", 
                              targetdiff, "_" , 
                              targetrapa))$padj[idx], 
    ReN_log2FC_2.2 = get(paste0("restab_", 
                                ...
                                targetdiff, "_" , 
                                targetrapa))$log2FoldChange[idx], 
    ReN_pval_2.2 = get(paste0("restab_", 
                              "ReN_sgNTC_sg2.2_", 
                              targetdiff, "_" , 
                              targetrapa))$padj[idx])
...
```{r noDIFF_RAPA,  fig.height=20, fig.width=15}
...
```{r DIFF_RAPA,  fig.height=20, fig.width=15}
...
getlinmodoutput_D62D224 = function(targetdiff, 
  ...
  samplesincl = SampleInfo$DIFF==targetdiff & 
    SampleInfo$RAPA==targetrapa &
    SampleInfo$CellLine %in% c("D62","D244")
...
```{r noDIFF_noRAPA_D62_D224,  fig.height=20, fig.width=15}

try(getlinmodoutput_D62D224(targetdiff = "noDIFF",targetrapa = "noRAPA"))
...
```{r noDIFF_RAPA_D62_D224,  fig.height=20, fig.width=15}
...
```{r DIFF_noRAPA_D62_D224,  fig.height=20, fig.width=15}
...
```{r DIFF_RAPA_D62_D224,  fig.height=20, fig.width=15}
