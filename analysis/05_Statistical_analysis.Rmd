...
```{r noDIFF_noRAPA_D62,  fig.height=25, fig.width=15}
...
getlinmodoutput_all(targetdiff = "noDIFF",targetrapa = "RAPA")
...
getlinmodoutput_all(targetdiff = "DIFF",targetrapa = "noRAPA")
...
getlinmodoutput_all(targetdiff = "DIFF",targetrapa = "RAPA")
